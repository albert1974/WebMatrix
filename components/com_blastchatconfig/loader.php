...
require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . trim($cloc) . DIRECTORY_SEPARATOR . 'api.blastchat.php');
if (is_file( JPATH_ROOT . DIRECTORY_SEPARATOR . trim($cloccustom) . DIRECTORY_SEPARATOR . 'api.blastchat.php')) {
	require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . trim($cloccustom) . DIRECTORY_SEPARATOR . 'api.blastchat.php');
	if (!isset($bcObject)) {
