...
class JConfig {
	...
	public $sitename = 'albert4Dev';				// Name of Joomla site
	...
	public $user = 'joomlauser989';							// MySQL username
	public $password = '[Z*|N06ng]Em';						// MySQL password
	public $db = 'my_site_db989';							// MySQL database name
